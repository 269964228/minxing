  ...
  <div id="all">
    ...
    <figure class="nesting">
      <div class="nesting_div">
        <div class="static_state">问题编号：</div>
        <div>{{data.draft.bianhao}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">起草时间：</div>
        <div>{{data.draft.qicaoshijian}}</div>
      </div>
      <div class="bgcolor">问题描述：</div>
      <div class="border">
        <div style="white-space:pre-wrap">{{data.draft.miaoshu}}</div>
      </div>
      ...
      <div class="nesting_div">
        <div class="static_state">问题类型：</div>
        <div>{{data.draft.leixing}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">提出问题单位：</div>
      ...
      <div class="nesting_div">
        <div class="static_state">问题涉及单位：</div>
        <div>{{data.draft.shejidanwei}}</div>
      </div>
      <div class="bgcolor">支行（部门）内部意见：</div>
      <div class="border">
        <div class="opinion_show" v-for="(v,i) in json.TCommnb" :key="i">
          <div v-html="v.content"></div>
      ...
      <div class="nesting_div">
        <div class="static_state">主办部门整改情况： 协办部门整改情况： 主办部门整改结论： 协办部门整改结论：</div>
        <div>{{data.draft.zhenggai}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">整改时限：</div>
        <div>{{data.draft.shixian}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">进度：</div>
        <div>{{data.draft.jindu}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">满意度：</div>
        <div>{{data.draft.manyidu}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">评价建议：</div>
        <div>{{data.draft.pingjia}}</div>
      </div>
    </figure>
    <!--<figure class="title">
