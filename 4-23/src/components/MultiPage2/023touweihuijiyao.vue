<template>
  <div id="all">
    <figure class="opinion">
        ...
        <div class="bgcolor">投委会副主任委员意见：</div>
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommfzrhld" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
    ...
    <figure class="title">
        ...
        <div class="character static_state">批复通知书：</div>
        <div>
    ...
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">投委会会议文号：</div>
            <div>{{data.draft.huiyiwenhao}}</div>
        </div>
        <div class="nesting_div">
