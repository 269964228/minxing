  ...
  <div id="all">
    ...
    <figure class="nesting">
      ...
      <div class="nesting_div" style="margin-left:5%">
        ...
        <div>{{data.draft.fashen}}</div>
      </div>
      <div class="nesting_div" style="margin-left:5%">
        <div class="static_state">是否经过法审意见修改完善：</div>
        <div>{{data.draft.fashenyijian}}</div>
      </div>
    </figure>
    ...
    <figure class="opinion">
      ...
      <div class="border">
        <div class="opinion_show" v-for="(v,i) in json.GXHTCommHld" :key="i">
          <div>{{v.content}}</div>
          <div style="float:right">
            {{v.user}}
            <span>({{v.time}})</span>
        ...
        <div class="opinion_show" v-for="(v,i) in json.GXHTCommBM" :key="i">
          <div>{{v.content}}</div>
          <div style="float:right">
            {{v.user}}
            <span>({{v.time}})</span>
