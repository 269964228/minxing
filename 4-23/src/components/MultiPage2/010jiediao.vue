<template>
  <div id="all">
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">人员类别：</div>
            <div>{{data.draft.leibie}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">工作单位：</div>
            <div>{{data.draft.danwei}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">门禁卡权限：</div>
            <div>{{data.draft.quanxian}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">门禁卡使用时间：</div>
            <div>{{data.draft.shiyongshijian}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">门禁卡使用时限：</div>
            <div>{{data.draft.shiyongshijian}}</div>
        </div>
        <div class="bgcolor">门禁卡申领原因：</div>
        <div class="border">
            <div style="white-space:pre-wrap">{{data.draft.shiyongyuanyin}}</div>
        </div>
        <figure class="title">
            <div class="static_state">上传身份证复印件：</div>
            <div>
    ...
    <figure class="opinion">
      ...
      <div class="bgcolor">人力资源部意见：</div>
      <div class="border">
        <div class="opinion_show" v-for="(v,i) in json.TCommRLSY" :key="i">
          <div v-html="v.content"></div>
          <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
        </div>
      </div>
