<template>
  <div id="all">
    <figure class="opinion">
        ...
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommzbyj" :key="i">
    ...
    <figure class="opinion">
        <div class="bgcolor">本月工作动态：</div>
        <div class="border">
            <div>{{data.draft.benyue}}</div>
        </div>
        <div class="bgcolor">下月工作动态：</div>
        <div class="border">
            <div>{{data.draft.xiayue}}</div>
        </div>
    </figure>
    <figure class="title">
