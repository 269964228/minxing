<template>
    <div id="all">
        <figure class="opinion">
            ...
            <div class="border">
                <div class="opinion_show" v-for="(v,i) in json.TCommngbm" :key="i">
        ...
        <figure class="nesting">
            ...
            <div class="nesting_div">
                <div class="static_state">总行部门：</div>
                <div>{{data.draft.zonghangbumen}}</div>
            </div>
            <div class="nesting_div">
                <div class="static_state">管辖支行：</div>
                <div>{{data.draft.guanxiazhihang}}</div>
            </div>
        </figure>
        <figure class="opinion">
            <div class="bgcolor">报送说明：</div>
            <div class="border">
                <div style="white-space:pre-wrap">{{data.draft.baosongshuoming}}</div>
            </div>
        </figure>
        <figure class="title">
            <div class="character static_state">报送文件模板：</div>
            <div>
        ...
        <figure class="title">
            <div class="character static_state">报送文件：</div>
            <div>
            <div v-for="(v,i) in data.attachlist" :key="i" @click="route(v)" class="enclo_div">
                <div>{{v.name}}</div>
            </div>
