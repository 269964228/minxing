<template>
  <div id="all">
    ...
    <figure class="title">
        ...
        <div class="character static_state">议题表决结果及意见：</div>
        <div>
            <div v-for="(v,i) in attachlist.common" :key="i" @click="route(v)" class="enclo_div">
                <div>{{v.name}}</div>
            </div>
        </div>
        <div class="character static_state">审批决议单：</div>
        <div>
            <div v-for="(v,i) in attachlist.common1" :key="i" @click="route(v)" class="enclo_div">
                <div>{{v.name}}</div>
            </div>
        </div>
    </figure>
    ...
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">对应报审单文号：</div>
