  ...
  <div id="all">
    ...
    <figure class="nesting">
      <div class="nesting_div">
        <div class="static_state">业务名称：</div>
        <div>{{data.draft.mingcheng}}</div>
      </div>
      <div class="nesting_div">
      ...
      <div class="nesting_div">
        <div class="static_state">申请日期：</div>
        <div>{{data.draft.riqi}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">发布起止时间：</div>
        <div>{{data.draft.qizhishijian}}</div>
      </div>
      <div class="nesting_div">
      ...
      <div class="nesting_div">
        <div class="static_state">邮箱：</div>
        <div>{{data.draft.youxiang}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">标题内容：</div>
        <div>{{data.draft.biaoti}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">申请类型：</div>
        <div>{{data.draft.shenqingleixing}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">发布的信息类型：</div>
        <div>{{data.draft.fabuleixing}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">发布栏目：</div>
        <div>{{data.draft.lanmu}}</div>
      </div>
      <div class="bgcolor">发布内容及形式需求（文字、广告、图片、视频、专题等）：</div>
      <div class="border">
        <div style="white-space:pre-wrap">{{data.draft.fabuneirong}}</div>
      </div>
    </figure>
    <figure class="title">
