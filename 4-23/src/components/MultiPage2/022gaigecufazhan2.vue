<template>
  <div id="all">
    ...
    <figure class="nesting">
      ...
      <div class="nesting_div">
        <div class="static_state">问题描述：</div>
        <div>{{data.draft.miaoshu}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">意见建议：</div>
        <div>{{data.draft.yijian}}</div>
      </div>
      <div class="nesting_div">
      ...
      <div class="bgcolor">部门整改结论：</div>
      <div class="border">
        <div style="white-space:pre-wrap">{{data.draft.jielun}}</div>
      </div>
      <div class="nesting_div">
