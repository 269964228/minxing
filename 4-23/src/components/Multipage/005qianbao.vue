<template>
  <div id="all">
    <figure class="opinion">
        ...
        <div class="bgcolor">主办部门办理结果：</div>
        <div class="border">
    ...
    <figure class="nesting">
        <div class="nesting_div">
            <div class="static_state">签报编号：</div>
            <div>{{data.draft.qianbaobianhao}}</div>
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            <div class="static_state">主送领导：</div>
            <div>{{data.draft.zhusonglingdao}}</div>            
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            ...
            <div>{{data.draft.nigaorendianhua}}</div>
        </div>
        <div class="nesting_div">
