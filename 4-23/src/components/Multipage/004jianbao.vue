<template>
  <div id="all">
    <figure class="opinion">
        <div class="bgcolor">行领导意见：</div>
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommhzRtf" :key="i">
        ...
        <div class="bgcolor">分管行领导意见：</div>
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommhldRtf" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
    ...
    <figure class="opinion">
        ...
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommbgsfzrRtf" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
        <div class="bgcolor">办公室编辑意见：</div>
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommBgsbjRtf" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
        ...
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommzbRtf" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
        ...
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommhqRtf" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
    ...
    <figure class="nesting">
        ...
        <div class="bgcolor">会签部门：</div>
        <div class="border">
            <div class="opinion_show">{{data.draft.huiqianbumen}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">报送：</div>
            <div>{{data.draft.baosong}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">发送：</div>
            <div>{{data.draft.fasong}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">简报编号：</div>
            <div>{{data.draft.jianbaobianhao}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">简报总号：</div>
            <div>{{data.draft.jianbaozonghao}}</div>
        </div>
        <div class="nesting_div">
