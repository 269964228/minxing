<template>
  <div id="all">
    ...
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">办文依据：</div>
            <div>{{data.draft.banwenyiju}}</div>
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            <div class="static_state">是否加入公文库：</div>
            <div>{{data.draft.shifougwk}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">是否为规章制度：</div>
            <div>{{data.draft.shifougzzd}}</div>
        </div>
    </figure>
