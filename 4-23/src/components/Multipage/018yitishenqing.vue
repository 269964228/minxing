<template>
  <div id="all">
    <figure class="opinion">
      ...
      <div class="bgcolor">分管行领导、相关行领导(或相关专业委员会)意见：</div>
      <div class="border">
        <div class="opinion_show" v-for="(v,i) in json.TCommhldsh" :key="i">
          <div v-html="v.content"></div>
          <div style="text-align:right">
            {{v.user}}
            <span>({{v.time}})</span>
      ...
      <div class="bgcolor">议题协办部门意见：</div>
      <div class="border">
    ...
    <figure class="title">
      <div class="character static_state">议题名称：</div>
    ...
    <div class="bgcolor">议题主办部门意见：</div>
    <div class="border">
      <div class="opinion_show" v-for="(v,i) in json.TCommAssist" :key="i">
        <div v-html="v.content"></div>
        <div style="text-align:right">
          {{v.user}}
          <span>({{v.time}})</span>
    ...
    <figure class="nesting">
      ...
      <div class="bgcolor">议题说明(包括议题的目的、作用以及提交总行办公会的必要性等)：</div>
      <div class="border">
        <div class="opinion_show">{{data.draft.yitishuoming}}</div>
      </div>
      <div class="bgcolor">需总行办公会讨论决定的主要事项：</div>
      <div class="border">
        <div class="opinion_show">{{data.draft.zhuyaoshixiang}}</div>
      </div>
    </figure>
