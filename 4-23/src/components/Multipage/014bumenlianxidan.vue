<template>
  <div id="all">
    ...
    <div class="character static_state" v-loading.fullscreen.lock="loading">附件：</div>
    <div>
    ...
    <div class="bgcolor">主要内容：</div>
    <div class="border">
      <div class="opinion_show" v-html="data.draft.zhuyaoneirong"></div>
    </div>
    <div class="nav">
      <div class="nav_div">
...
export default {
  data() {
    return {
      ...
      attachData: {},
      format: [
        "doc","docx","wps","odt","rtf","xls","xlsx","et","ods","csv","ppt","pptx",
        "dps","odp","pdf","txt","jpg","jpeg","gif","png","bmp","tif","mp3","m4a",
        "mid","wma","mp4","zip","rar","tar","dwg","dxf","dwf","html","htm","xml",
        "js","css","java","php","sql"
      ]
    };
  },
