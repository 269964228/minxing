<template>
  <div id="all">
    <figure class="opinion">
        ...
        <!-- 直接提交 -->
        <!-- 
        <div class="submit" v-if="data.flowsend
    ...
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">督办员：</div>
            <div>{{data.draft.zhusong}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">监测评估结果：</div>
            <div>{{data.draft.zhusong}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">督办内容：</div>
            <div>{{data.draft.dubanneirong}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">督办依据：</div>
            <div>{{data.draft.yiju}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">分管行领导：</div>
            <div>{{data.draft.fenguan}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">主办部门：</div>
            <div>{{data.draft.zhuban}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">协办部门：</div>
            <div>{{data.draft.xieban}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">质量反馈关键字：</div>
            <div>{{data.draft.guanjianzi}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">反馈频次：</div>
            <div>{{data.draft.pinci}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">发文单位：</div>
            <div>{{data.draft.danwei}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">来文时间：</div>
            <div>{{data.draft.laiwenshijian}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">文件字号：</div>
            <div>{{data.draft.zihao}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">完成时限：</div>
            <div>{{data.draft.shixian}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">立项时间：</div>
            <div>{{data.draft.lixiangshijian}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">收文总号：</div>
            <div>{{data.draft.zonghao}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">重要督办事项：</div>
            <div>{{data.draft.shixiang}}</div>
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            <div class="static_state">督办机构类别：</div>
            <div>{{data.draft.jigouleixing}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">督办事项：</div>
            <div>{{data.draft.dubanshixiang}}</div>
        </div>
    </figure>
