<template>
  <div id="all">
    ...
    <figure class="nesting">
      ...
      <div class="nesting_div">
        <div class="static_state">送呈日期：</div>
        <div>{{data.draft.songchengriqi}}</div>
      </div>
      <div class="nesting_div">
        <div class="static_state">完成时限：</div>
        <div>{{data.draft.wanchengshixian}}</div>
      </div>
      <div class="nesting_div">
      ...
      <div class="nesting_div">
        <div class="static_state">事由：</div>
        <div>{{data.draft.shiyou}}</div>
      </div>
    </figure>
