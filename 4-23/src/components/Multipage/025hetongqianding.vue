  ...
  <div id="all">
    ...
    <figure class="nesting">
        <div class="nesting_div">
            <div class="static_state">经办单位：</div>
            <div>{{data.draft.jingbandanwei}}</div>
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            <div class="static_state">合同类型：</div>
            <div>{{data.draft.hetongleixing}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">对方当事人名称：</div>
            <div>{{data.draft.duifangmingcheng}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">是否本行格式文本：</div>
            <div>{{data.draft.benhanggeshi}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">合同名称：</div>
            <div>{{data.draft.hetongmingcheng}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">付款方：</div>
            <div>{{data.draft.fukuanfang}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">合同金额:</div>
            <div>{{data.draft.hetongjine}}</div>
        </div>
        <figure class="nesting">
            <div class="bgcolor">合同要点描述：</div>
            <div class="border">
                <div style="white-space:pre-wrap">{{data.draft.yaodianmiaoshu}}</div>
            </div>
        </figure>

        <div class="nesting_div">
            <div class="static_state">签订日期：</div>
            <div>{{data.draft.qiandingriqi}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">生效日期：</div>
            <div>{{data.draft.shengxiaoriqi}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">终止日期：</div>
            <div>{{data.draft.zhongqiriri}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">期限(月)：</div>
            <div>{{data.draft.qixian}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">联系方式：</div>
            <div>{{data.draft.lianxifangshi}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">合同经办人：</div>
            <div>{{data.draft.jingbanfang}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">合同状态：</div>
            <div>{{data.draft.zhuangtai}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">创建日期：</div>
            <div>{{data.draft.chuangjianriqi}}</div>
        </div>
        <div class="nesting_div">
