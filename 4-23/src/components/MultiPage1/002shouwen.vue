<template>
  <div id="all">
    <figure class="opinion">
      <div class="bgcolor">管辖支行行领导批示：</div>
      <div class="border">
      ...
      <div class="border">
        ...
        <div class="opinion_show" v-for="(v,i) in json.TCommzbPrint" :key="i">
          <div v-html="v.content"></div>
          <div style="text-align:right">
            {{v.user}}
            <span>({{v.time}})</span>
    ...
    <figure class="nesting">
      ...
      <div class="nesting_div">
        <div class="static_state">传阅部门：</div>
        <div>{{data.draft.chuanyuebumen}}</div>
      </div>
    </figure>
    <figure class="opinion">
      <div class="bgcolor">办理结果：</div>
      <div class="border">
        <div style="white-space:pre-wrap">{{data.draft.banlijieguo}}</div>
      </div>
