<template>
  <div id="all">
    ...
    <figure class="opinion">
        ...
        <div class="bgcolor">会签部门审核意见：</div>
        <div class="border">
    ...
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">拟稿时间：</div>
            <div>{{data.draft.huiyishijian}}</div>
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            <div class="static_state">校对签字：</div>
            <div>{{data.draft.qianzi}}</div>
        </div>
        <div class="nesting_div">
            <div class="static_state">封发日期：</div>
            <div>{{data.draft.fengfariqi}}</div>
        </div>
