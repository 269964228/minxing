<template>
  <div id="all">
    <figure class="opinion">
      ...
      <div class="border">
        <div class="opinion_show" v-for="(v,i) in json.TCommzhbfzr" :key="i">
          <div v-html="v.content"></div>
          <div style="text-align:right">
            {{v.user}}
            <span>({{v.time}})</span>
    ...
    <figure class="nesting">
      ...
      <div class="nesting_div">
        <div class="static_state">主题词：</div>
        <div>{{data.draft.zhutici}}</div>
      </div>
      <div class="nesting_div">
