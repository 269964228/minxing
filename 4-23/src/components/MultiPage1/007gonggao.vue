<template>
  <div id="all">
    <figure class="opinion">
        ...
        <div class="bgcolor">综合管理部负责人审核：</div>
        <div class="border">
        ...
        <div class="bgcolor">主办部门负责人审核：</div>
        <div class="border">
            <div class="opinion_show" v-for="(v,i) in json.TCommzbbm" :key="i">
                <div v-html="v.content"></div>
                <div style="text-align:right">{{v.user}}<span>({{v.time}})</span></div>
            </div>
        </div>
    ...
    <figure class="title">
        <div class="character static_state">通知标题：</div>
        <div>{{data.draft.tongzhibiaoti}}</div>
    ...
    <figure class="nesting">
        ...
        <div class="nesting_div">
            <div class="static_state">主办人：</div>
            <div>{{data.draft.zhubanren}}</div>
        </div>
        <div class="nesting_div">
        ...
        <div class="nesting_div">
            <div class="static_state">办公室编辑：</div>
            <div>{{data.draft.biangongshibianji}}</div>
        </div>
    </figure>
