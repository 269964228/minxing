<template>
  <div id="all">
    <figure class="opinion">
      ...
      <div class="bgcolor">主管行领导批示：</div>
      <div class="border">
        <div class="opinion_show" v-for="(v,i) in json.TCommhldZG" :key="i">
          <div v-html="v.content"></div>
          <div style="text-align:right">
            {{v.user}}
            <span>({{v.time}})</span>
    ...
    <figure class="nesting">
      ...
      <div class="nesting_div">
        <div class="static_state">报送日期：</div>
        <div>{{data.draft.baosongriqi}}</div>
      </div>
      <div class="nesting_div">
