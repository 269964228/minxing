  ...
  <div id="all">
    <figure class="nesting">
      ...
      <figure class="opinion">
        <div class="bgcolor">传阅意见：</div>
        <div class="border">
          <div class="opinion_show" v-for="(v,i) in json.TCommCYYJ" :key="i">
            <div>{{v.content}}</div>
...
export default {
  ...
  created() {
    var that = this;
    if (location.href.external) {
      var json = {};
      json.type = "viewdocument";
      var jsondoc = {};
      jsondoc.key = location.href.appid;
      jsondoc.unid = location.href.unid;
      jsondoc.dbpath = location.href.dbpath;
    }else {
